          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group reqsn_cls" id="reqsn">
                ...
                <select name="issue_slip_no" class="form-control selct2" id="issue_slip_no">
                  <?php foreach ($issue_slip_master as $key => $value) { ?>
                    <option value="<?php echo $value->issue_slip_no; ?>"><?php echo $value->issue_slip_no; ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
