          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="client_name" class="form-control" id="client_name" placeholder="Client Name" value="<?php echo set_value('client_name', (((isset($detail->client_name)) && $detail->client_name != '') ? $detail->client_name : '')); ?>">
                <?php echo form_error('client_name', '<div class="error_message">', '</div>'); ?>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
