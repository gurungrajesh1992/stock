<section class="content">
    <div class="container-fluid">
        ...
        <form action="<?php echo base_url('location_transfer/admin/search'); ?> " method="post">
            <div class="row">
                <div class="col-md-10 offset-md-1">
                    ...
                    <div class="form-group">
                        <div class="input-group input-group-lg">
                          <input type="search" name="transfer_code" class="form-control" placeholder="Transfer Code" value="">
