...
class Admin extends Auth_controller
{
	...
	public function search($page = '')
	{
		...
		$all_data = $this->crud_model->count_all_data('location_transfer', $data_filter);
		// var_dump($all_data);
		// exit;
		...
		$items = $this->crud_model->get_all_data('location_transfer', $data_filter, $config['per_page'], $page);
