<section class="content">
    <div class="container-fluid">
        ...
        <form action="<?php echo base_url('issue/admin/search'); ?> " method="post">
            <div class="row">
                <div class="col-md-10 offset-md-1">
                    <div class="row">
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <input type="date" name="issue_date_from" class="form-control" placeholder="Issue Date" value="">
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group">
                                <label> Issue Date to:</label>
                                <input type="date" name="issue_date_to" class="form-control" placeholder="Issue Date" value="">
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="input-group input-group-lg">
                            ...
                            <div class="col-5"><input type="search" name="issue_no" class="form-control" placeholder="Issue No" value=""></div>
