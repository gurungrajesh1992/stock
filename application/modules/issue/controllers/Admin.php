...
class Admin extends Auth_controller
{
	...
	public function search($page = '')
	{
		...
		$staff_id = $this->input->post('staff_id');
		$department_id = $this->input->post('department_id');
		$issue_date_from = $this->input->post('issue_date_from');
		$issue_date_to = $this->input->post('issue_date_to');
		$requisition_no = $this->input->post('requisition_no');
		...
		$data_filter = array(
			'created_on >=' => $issue_date_from,
			'created_on <=' => $issue_date_to,
		...
		$all_data = $this->crud_model->count_all_data('issue_slip_master', $data_filter);
		// var_dump($all_data);
		// exit;
		...
		$items = $this->crud_model->get_all_data('issue_slip_master', $data_filter, $config['per_page'], $page);
