                                ...
                                <div class="col-md-12">
                                    <div class="req_item" id="items">
                                        ...
                                        if (isset($master_detail->sale_no)) {
                                            ...
                                            if ($childs) {
                                                $issue_slip_date = ((isset($master_detail->sales_date)) && $master_detail->sales_date != '') ? $master_detail->sales_date : date('Y-m-d');
                                                // var_dump($issue_slip_date);
                                                // exit;
