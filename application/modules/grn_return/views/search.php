<section class="content">
    <div class="container-fluid">
        ...
        <form action="<?php echo base_url('grn_return/admin/search'); ?> " method="post">
            <div class="row">
	...
	?>
                    ...
                    <div class="form-group">
                        <div class="input-group input-group-lg">
                          <div class="col-5"><input type="search" name="grn_no" class="form-control" placeholder="GRN No" value=""></div>
                         <div class="col-5"><input type="search" name="grn_return_no" class="form-control" placeholder="GRN Return No" value=""></div>
