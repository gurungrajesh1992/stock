                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="purchase_request_no" class="form-control" id="purchase_request_no" placeholder="Purchase Request" value="<?php echo set_value('purchase_request_no', (((isset($master_detail->purchase_request_no)) && $master_detail->purchase_request_no != '') ? $master_detail->purchase_request_no : '')); ?>" readonly>
