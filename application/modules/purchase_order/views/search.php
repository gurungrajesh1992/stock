<section class="content">
    <div class="container-fluid">
        ...
        <form action="<?php echo base_url('purchase_order/admin/search'); ?> " method="post">
            <div class="row">
                <div class="col-md-10 offset-md-1">
                    ...
                    <div class="form-group">
                        <div class="input-group input-group-lg">
                         <div class="col-5"> <input type="search" name="purchase_order_no" class="form-control" placeholder="Purchase Order No" value=""></div>
