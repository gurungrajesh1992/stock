<section class="content">
        <div class="container-fluid">
            ...
            <form action="<?php echo base_url('requisition/admin/search');?> " method="post">
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                        <div class="row">
                            <div class="col-3">
                                <div class="form-group">
                                    <label>	Requisition Date From:</label>
                                    <input type="date" name="requisition_date_from" class="form-control" placeholder="Requisition Date" value="">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                    <label>	Requisition Date to:</label>
                                    <input type="date" name="requisition_date_to" class="form-control" placeholder="Requisition Date" value="">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="input-group input-group-lg">
                                <input type="search" name="requisition_no" class="form-control" placeholder="Requisition No" value="">
