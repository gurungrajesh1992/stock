                ...
                ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <?php } ?>
                        <?php
                        $check_scrap_view = $this->crud_model->get_module_function_for_role('scrap', 'view');
                        if ($check_scrap_view == true) {
                        ?>
                          <a href="<?php echo base_url($redirect . '/admin/view/' . $value->id); ?>" class="btn btn-sm btn-info" style="margin: 5px;">View</a>
                        <?php } ?>
                        <?php
                        $check_scrap_soft_delete = $this->crud_model->get_module_function_for_role('scrap', 'soft_delete');
                        if ($check_scrap_soft_delete == true) {
                        ?>
