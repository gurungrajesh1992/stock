              ...
              <tbody>
                ...
                if ($items) {
                  foreach ($items as $key => $value) {
                    ...
                    $item_detail = $this->crud_model->get_where_single_order_by('item_infos', array('item_code' => $value->item_code), 'id', 'DESC');
                ?>
                    <tr>
                      <td><?php echo $key + 1; ?></td>
                      <td><?php echo $value->scrap_code; ?></td>
                      <td><?php echo $value->date; ?></td>
                      <td><?php echo (isset($item_detail->item_name) && $item_detail->item_name != '') ? $item_detail->item_name : ''; ?></td>
